...
export class SetLeaderboardHandler implements ICommandHandler<SetLeaderboardCommand>{
  constructor(
  ...
  async execute() {
    ...
    const communitiesPromise = await this.httpService.get(url + '/api/community/leaderboard').toPromise();
